...
violence_item_descriptions <- c(
  ...
  "humillaciones",
  "amenazas",
  "empujar, sacudir, arrojar",
  "cachetadas o retorcer el brazo",
  "golpear con el puño",
  "patear o arrastrar",
  "fuerza bruta para tener sexo",
  "obligó a tener sexo",
  "revisó redes sociales personales",
  "reviso mensajes personales",
  "compartió fotos íntimas"
)
...
subgroup_violence_item_plot <- plot_coefs(
  data = filter(subgroup_violence_item_plot_data, id == "Baseline IPV"),
  facets = "index", 
  levels = c(
    "Actitudes\ncontroladoras",
    "Violencia\nPsicológica",
  ...
  xlabel = "Efecto de HEP") 

ggsave(
  filename = "7_figures/subgroup_violence_item_plot_esp.pdf",
  plot = subgroup_violence_item_plot,
  device = "pdf",
  width = 6,
  height = 6
...
ggsave(
  filename = "7_figures/subgroup_violence_item_plot_alt.pdf",
  plot = subgroup_violence_item_plot,
  device = "pdf",
  width = 6,
  height = 6
